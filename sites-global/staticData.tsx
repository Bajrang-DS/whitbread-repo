export const StaticData = {
    Meta_title:" Whitbread Demo Store",
    Meta_description:"Visit Whitbread Demo Store | Whitbread is your local great value family retailer shop. Find latest seasonal looks for Women, Men and kids, plus a huge range of homeware.",
