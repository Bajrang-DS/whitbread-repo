...
//   thursday: 4,
//   friday: 5,
//   saturday: 6,     //comment out this code if don't want to see today in first raw
//   sunday: 7,
// };
...
const renderHours = (week: Week, c_specific_day: any) => {
  ...
  // dayDom.sort(function sortByDay(a: any, b: any) {  //comment out this code if don't want to see today in first raw
