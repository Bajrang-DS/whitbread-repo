            ...
            <div className="is-layout-flow wp-block-group animate viewed" id="content">
                <div className="wp-block-group__inner-container">
                    ...
                    <a className="btn aligncenter style-col int" href="#" target="_self">
                       {c_servicesitems.cta.label} <svg  role="img" aria-hidden="true" width="13" height="11" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8 1.415l4 4-4 4" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path><path d="M11 5.414H1" stroke="#fff" strokeWidth="2" strokeLinecap="round"></path></svg>
                    </a>
                </div>
            </div>
